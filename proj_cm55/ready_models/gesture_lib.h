...
// Model GUID (16 bytes)
#define IMAI_MODEL_ID {0x49, 0x4d, 0x52, 0x4d, 0x8b, 0xc2, 0x76, 0x3b, 0x0c, 0x02, 0x8a, 0x44, 0xb4, 0x3e, 0x6b, 0x43, 0xcb, 0x15, 0x4b, 0xff}
...
#define IMAI_DATA_OUT_SYMBOLS {"unlabelled", "Push", "SwipeDown", "SwipeLeft", "SwipeRight", "SwipeUp"}

// data_in [5] (20 bytes)
#define IMAI_DATA_IN_RANK (1)
#define IMAI_DATA_IN_SHAPE (((int[]){5})
