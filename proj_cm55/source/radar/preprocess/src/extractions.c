...
/*******************************************************************************
* Function Name: new_preproc_work_arrays
********************************************************************************
* Summary:
...
static void _get_single_range_bin_doppler(
    ifx_cf64_t *x_range, preproc_work_arrays *arr, uint32_t range_bin,
    frame_cfg *f_cfg
)
{
    slice_3d_col_cf64(
...
static void _get_doppler_profile(
    ifx_cf64_t *x_doppler, preproc_work_arrays *arr, frame_cfg *f_cfg
)
{
    arm_cmplx_mag_f32(
...
*  `new_preproc_work_arrays()` to create the instance of this
